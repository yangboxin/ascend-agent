...
from ascend_agent.cli.model_catalog import PROVIDER_PRESETS, split_model_id
...
class ConfigManager:
    ...
    The persisted shape mirrors opencode's simple split:
    ...
    Older {"active_provider": ..., "providers": [...]} files are still accepted.
    """
