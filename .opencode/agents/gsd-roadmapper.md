...
Reference full template: `/Users/ybx/ascend-agent/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/ybx/ascend-agent/.opencode/get-shit-done/templates/state.md`.
