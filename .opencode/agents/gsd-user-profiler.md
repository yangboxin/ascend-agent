...
<reference>
@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/ybx/ascend-agent/.opencode/get-shit-done/references/user-profiling.md` to load:
