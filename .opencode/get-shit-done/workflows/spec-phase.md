...
```bash
INIT=$(node "/Users/ybx/ascend-agent/.opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ybx/ascend-agent/.opencode/get-shit-done/templates/spec.md.
