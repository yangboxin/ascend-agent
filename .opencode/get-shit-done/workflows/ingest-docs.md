...
```bash
INIT=$(node "/Users/ybx/ascend-agent/.opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/ybx/ascend-agent/.opencode/get-shit-done/bin/gsd-tools.cjs" commit \
