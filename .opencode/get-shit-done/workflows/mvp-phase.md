...
<required_reading>
@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/user-story-template.md
@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/spidr-splitting.md
@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `question` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/spidr-splitting.md`. Briefly:
