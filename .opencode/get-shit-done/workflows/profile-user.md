...
Key references:
- @/Users/ybx/ascend-agent/.opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/ybx/ascend-agent/.opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/ybx/ascend-agent/.opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/ybx/ascend-agent/.opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/ybx/ascend-agent/.opencode/get-shit-done/USER-PROFILE.md" "/Users/ybx/ascend-agent/.opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/ybx/ascend-agent/.opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/ybx/ascend-agent/.opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/ybx/ascend-agent/.opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/ybx/ascend-agent/.opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/ybx/ascend-agent/.opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/ybx/ascend-agent/.opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/ybx/ascend-agent/.opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/ybx/ascend-agent/.opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/ybx/ascend-agent/.opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/ybx/ascend-agent/.opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/ybx/ascend-agent/.opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/ybx/ascend-agent/.opencode/AGENTS.md
```
