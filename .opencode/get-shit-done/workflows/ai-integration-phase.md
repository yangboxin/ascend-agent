...
<required_reading>
@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/ai-frameworks.md
@/Users/ybx/ascend-agent/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/ybx/ascend-agent/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/ybx/ascend-agent/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/ybx/ascend-agent/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/ybx/ascend-agent/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/ybx/ascend-agent/.opencode/agents/gsd-eval-planner.md for instructions.
