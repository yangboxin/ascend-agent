...
```markdown
Read /Users/ybx/ascend-agent/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/ybx/ascend-agent/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/ybx/ascend-agent/.opencode/agents/gsd-ui-checker.md for instructions.
