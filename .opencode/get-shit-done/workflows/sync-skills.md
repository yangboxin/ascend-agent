...
INSTALL_JS_GLOBAL="/Users/ybx/ascend-agent/.opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/ybx/ascend-agent/.opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
