...
```
Agent(
  prompt="Read /Users/ybx/ascend-agent/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ybx/ascend-agent/.opencode/get-shit-done/templates/VALIDATION.md`
