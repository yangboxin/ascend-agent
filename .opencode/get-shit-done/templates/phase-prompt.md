...
<!-- For checkpoint task examples and patterns, see @/Users/ybx/ascend-agent/.opencode/get-shit-done/references/checkpoints.md -->
...
See `/Users/ybx/ascend-agent/.opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/ybx/ascend-agent/.opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/ybx/ascend-agent/.opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
