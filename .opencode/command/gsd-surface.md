...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/ybx/ascend-agent/.opencode/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/Users/ybx/ascend-agent/.opencode/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/Users/ybx/ascend-agent/.opencode/commands/gsd
AGENTS_DIR=/Users/ybx/ascend-agent/.opencode/agents
```
...
<execution_context>
Surface state file: `/Users/ybx/ascend-agent/.opencode/skills/.gsd-surface.json`
Install profile marker: `/Users/ybx/ascend-agent/.opencode/skills/.gsd-profile`
Engine module: `/Users/ybx/ascend-agent/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/Users/ybx/ascend-agent/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
